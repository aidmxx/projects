...
public class GameEngineImpl implements GameEngine {
    ...
    private RenderableFactoryRegistry getRenderableFactoryRegistry() {
        ...
        renderableFactoryRegistry.registerFactory(RenderableType.POKEY, new ClydeFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.SHADOW, new BlinkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.SPEEDY, new PinkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.BASHFUL, new InkyFactory());
