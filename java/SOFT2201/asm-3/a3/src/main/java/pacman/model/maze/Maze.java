...
public class Maze {
    ...
    public void addRenderable(Renderable renderable, char renderableType, int x, int y) {
        if (renderable != null) {
            ...
            } else if (renderableType == RenderableType.POKEY || renderableType == RenderableType.BASHFUL || renderableType == RenderableType.SHADOW || renderableType == RenderableType.SPEEDY) {
