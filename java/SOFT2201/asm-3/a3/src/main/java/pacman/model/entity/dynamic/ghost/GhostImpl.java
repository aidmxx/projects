...
import pacman.model.states.ChaseState;
import pacman.model.states.FrightenedState;
import pacman.model.states.GhostState;
import pacman.model.states.ScatterState;
...
import static pacman.model.entity.dynamic.ghost.GhostMode.FRIGHTENED;
...
public class GhostImpl implements Ghost {
    ...
    private final GhostState chaseState;
    private final GhostState scatterState;
    private final GhostState frightenedState;
    private GhostState currentState;
    private Image frightened = new Image("maze/ghosts/frightened.png");
    ...
    public GhostImpl(Image image, BoundingBox boundingBox, KinematicState kinematicState, GhostMode ghostMode, Vector2D targetCorner, ChaseStrategy chaseStrategy) {
        ...
        this.chaseState = new ChaseState(this.chaseStrategy);
        this.scatterState = new ScatterState(this.targetCorner);
        this.frightenedState = new FrightenedState(this.startingPosition);
        this.currentState = switch (this.ghostMode) {
    ...
    private Vector2D getTargetLocation() {
        return currentState.getTargetLocation(this.playerPosition, this);
    }
    ...
    public void setGhostMode(GhostMode ghostMode) {
        ...
        // change image
        if (ghostMode.FRIGHTENED == ghostMode){
