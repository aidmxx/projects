...
public class Pacman implements Controllable {
    ...
    public Pacman(
        ...
        //System.out.println("KinematicState: " + this.kinematicState);
    ...
    public void collideWith(Level level, Renderable renderable){
        if (level.isCollectable(renderable)){
            ...
            collectable.collect();
            // score update
            ((LevelImpl) level).toCollect(collectable);
        }
    }
    ...
    public void reset(){
        if (kinematicState == null) {
            throw new IllegalStateException("KinematicState is null during reset");
        }
